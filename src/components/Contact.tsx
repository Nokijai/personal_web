        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              ...
              className="inline-flex items-center justify-center gap-3 px-8 py-4 rounded-xl glass-card hover-glow hover:border-accent-primary/30 transition-all duration-300"
            >
            ...
            {/* LinkedIn contact */}
            <a
              href="https://linkedin.com/in/noki-chau-a28077321"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center gap-3 px-8 py-4 rounded-xl glass-card hover-glow hover:border-accent-primary/30 transition-all duration-300"
            >
